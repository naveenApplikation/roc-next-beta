  ...
  return (
    <WalkListModal
      ...
      <div
        ...
        <p>
          As we fine-tune our features, your feedback is invaluable. While not
          everything may be fully functional yet, your participation is key in
          shaping the future of our platform. Thank you for being part of this
          journey with us.
        </p>
        <div style={{ padding: "20px 0px" }}   onClick={() => {
        closeModal("");
