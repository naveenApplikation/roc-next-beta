...
const Resturants: React.FC<ResturantsProps> = (props) => {
  return (
      <CommunityBody>
        <p className='communityName'>Top Rated Resturants</p>
...
export default Layout(Resturants)