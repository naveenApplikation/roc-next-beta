...
import { dining, drinks,hearts, smily, XmasBgImage } from "../utils/XmasImagePath"
    ...
    return (
      <div key={index} className="flex flex-col  w-[80px] gap-[8px]">
        <div className="relative w-[80px]  rounded-[8px]">
          <Image height={80} width={80} alt="" objectFit="cover" src={XmasBgImage} className="rounded-[8px]" />
          <div className="absolute bottom-[4px] left-[4px] w-[30px] text-center bg-white rounded-[4px]">
            <p className="text-[17px] font-extrabold leading-normal">29</p>
